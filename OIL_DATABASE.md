...
## Complete Oil Database

Here's the table with the ID column removed:

| Oil Name | SAP | Iodine | INS | Lauric | Myristic | Palmitic | Stearic | Ricinoleic | Oleic | Linoleic | Linolenic |
|---|---|---|---|---|---|---|---|---|---|---|---|
...
- **SAP**: Saponification value (amount of alkali needed to saponify the oil)
- **Iodine**: Iodine value (measure of unsaturation)
- **INS**: Combined hardness/cleansing value (higher = harder bar)
- **Fatty Acids**: All values are percentages (%)
  - Lauric (12:0), Myristic (14:0), Palmitic (16:0), Stearic (18:0): Saturated
  - Ricinoleic (18:1): MonoUnsaturated
